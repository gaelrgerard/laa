...
This process able an end user to request the SAM SD memory reset. A strong confirmation SHOULD be required as defined in [SAMREQ](LAA__References.md#SAMREQ)
...
This process able an end user to request the list of all SAM Services. No user intent is required for this operation.


### End user interactions for user intent

End user intent is acquired as defined in [SAMREQ](LAA__References.md#SAMREQ). End user intent is acquired in advance or in real time. This process depends of the device and is implementation specific.
